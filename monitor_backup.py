...
# ========== CONFIG - EDIT THESE ==========
KALI_IP            = "172.16.32.119"     # THIS (defender) machine - never block ourselves
RPC_URL            = "http://127.0.0.1:8545"
PRIVATE_KEY        = "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80"  # Hardhat test key #0
TELEGRAM_BOT_TOKEN = "8928904439:AAFhBq0jigs6LuT83GfOucyrc_oACtyxV8M"    # get from @BotFather
TELEGRAM_CHAT_ID   = "8334964723"      # get from @userinfobot
# =========================================
